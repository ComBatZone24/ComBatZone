 ...
 * - TrendingTopicsOutput: Output from a a a the flow.
 */
...
const TrendingTopicSchema = z.object({
    ...
    audience: z.string().describe("A description of the primary audience or demographic most interested in this trend (e.g., 'Gamers, tech enthusiasts', 'Crypto traders, financial news followers', 'General Pakistani youth')."),
...
const prompt = ai.definePrompt({
    ...
    prompt: `
        ...
        Your task is to identify the most significant trending topics for a specific platform, focusing on the Pakistani audience, broader global events, and the cryptocurrency market.
